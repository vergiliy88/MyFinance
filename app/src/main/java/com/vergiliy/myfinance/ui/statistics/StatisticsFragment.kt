...
import com.vergiliy.myfinance.databinding.FragmentStatisticsBinding
...
class StatisticsFragment: BaseFragment<FragmentStatisticsBinding>() {
        ...
        buttonDateFrom.setOnClickListener {
            val dpd = DatePickerDialog(requireContext(), { view, year, monthOfYear, dayOfMonth ->
                ...
                buttonDateFrom.text = "${dayOfMonth}." +
                        "${Utils.convertMonthFromCal(monthOfYear)}." +
                        "$year"
    ...
    private fun setData(list: List<PaymentStatistic>) {
        ...
        chart.data = data
        chart.invalidate()
        chart.centerText = "${resources.getString(R.string.label_total)} - $sum${resources.getString(R.string.currency)}"
